...
//		HttpSession sc = req.getSession();
		...
		Cookie c = new Cookie("OriginalCap", cap);
		resp.addCookie(c);
		String s=(String)req.getAttribute("result");
//		sc.setAttribute("OriginalCap", cap);
		if(s != null)
			p.println("<html><body><h2>Incorrect</h2></body></html>");

		
		p.println("<html><body><h1>" + cap + "</h1>" + "<form action='second' method='post'>"

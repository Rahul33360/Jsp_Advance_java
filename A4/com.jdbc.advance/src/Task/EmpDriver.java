...
public class EmpDriver {
	...
	private static void updateEmp() {
		System.out.println("Enter the Emp ID on you want to perform Update");
		int toUpdateId = s.nextInt();
		System.out.println("Press 1 for EmpId \nPress 2 for EmpName \nPress 3 for EmpAge ");
		int operation = s.nextInt();
		
		if(EmpService.update(toUpdateId,operation))
